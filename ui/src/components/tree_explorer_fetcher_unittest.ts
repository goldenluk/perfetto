...
// extra properties (see computeTree).
const TREE_COLUMNS = [
  'id',
  'parentId',
  'depth',
...
// A fake trace whose engine responds to exactly the SQL that
// TreeExplorerFetcher issues, recording every statement so tests can assert
// on the CREATE/DROP traffic.
