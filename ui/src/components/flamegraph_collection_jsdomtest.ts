...
// The real TreeExplorerPanel drives engine queries; stub it with a component
...
// plus the attrs captured by the stubbed TreeExplorerPanel. The DataGrid
...
function metricFor(keys: ReadonlyArray<string>): TreeExplorerQueryMetric {
  return {
    name: 'cpu (ns)',
    unit: 'ns',
