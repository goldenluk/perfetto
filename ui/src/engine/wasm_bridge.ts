...
// Upper bound on how many bytes we hand to Wasm in one write, which is also
// the size of the standing reservation held for us in the C++ RPC tokenizer.
...
export class WasmBridge {
  ...
  // cwrap() with numeric args hands back the raw wasm export; ccall() would
  // redo the lookup and marshalling on every call.
